...
def main():
    ...
    parser.add_argument('--ignore-ssl', '-i', default=False, action='store_true', help='Whether to validate SSL Certs')
    ...
    pm = PypiMirror(args.mirror_root, pypi_mirror_url=args.mirror, verify=not args.ignore_ssl, timeout=args.timeout, workers=args.workers)
